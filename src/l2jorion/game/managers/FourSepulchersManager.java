...
public class FourSepulchersManager extends GrandBossManager
{
	...
	protected HashMap<Integer, int[]> _startHallSpawns = new HashMap<>();
	protected HashMap<Integer, Integer> _hallGateKeepers = new HashMap<>();
	protected HashMap<Integer, Integer> _keyBoxNpc = new HashMap<>();
	protected HashMap<Integer, Integer> _victim = new HashMap<>();
	protected HashMap<Integer, L2PcInstance> _challengers = new HashMap<>();
	protected HashMap<Integer, L2Spawn> _executionerSpawns = new HashMap<>();
	protected HashMap<Integer, L2Spawn> _keyBoxSpawns = new HashMap<>();
	protected HashMap<Integer, L2Spawn> _mysteriousBoxSpawns = new HashMap<>();
	protected HashMap<Integer, L2Spawn> _shadowSpawns = new HashMap<>();
	protected HashMap<Integer, ArrayList<L2Spawn>> _dukeFinalMobs = new HashMap<>();
	protected HashMap<Integer, ArrayList<L2SepulcherMonsterInstance>> _dukeMobs = new HashMap<>();
	protected HashMap<Integer, ArrayList<L2Spawn>> _emperorsGraveNpcs = new HashMap<>();
	protected HashMap<Integer, ArrayList<L2Spawn>> _magicalMonsters = new HashMap<>();
	protected HashMap<Integer, ArrayList<L2Spawn>> _physicalMonsters = new HashMap<>();
	protected HashMap<Integer, ArrayList<L2SepulcherMonsterInstance>> _viscountMobs = new HashMap<>();
