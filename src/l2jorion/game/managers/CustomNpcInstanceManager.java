...
public final class CustomNpcInstanceManager
{
	...
	private HashMap<Integer, customInfo> spawns;
	private HashMap<Integer, customInfo> templates;
	 ...
	 */
	public final HashMap<Integer, customInfo> getAllTemplates()
	{
		return templates;
	}
	 ...
	 */
	public final HashMap<Integer, customInfo> getAllSpawns()
	{
		return spawns;
	}
