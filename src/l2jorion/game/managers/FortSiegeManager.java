...
public class FortSiegeManager
{
	...
	// Fort Siege settings
	private HashMap<Integer, ArrayList<SiegeSpawn>> _commanderSpawnList;
	private HashMap<Integer, ArrayList<SiegeSpawn>> _flagList;
	...
	private final void load()
	{
		...
		try
		{
			...
			{
				final ArrayList<SiegeSpawn> _commanderSpawns = new ArrayList<>();
				final ArrayList<SiegeSpawn> _flagSpawns = new ArrayList<>();
	...
	// =========================================================
	// Property - Public
	public final ArrayList<SiegeSpawn> getCommanderSpawnList(final int _fortId)
	{
	...
	public final ArrayList<SiegeSpawn> getFlagList(final int _fortId)
	{
