...
public class SkillsEngine
{
	...
	{
		hashFiles("data/xml/stats/armor", _armorFiles);
		hashFiles("data/xml/stats/weapon", _weaponFiles);
	...
	{
		final List<L2Armor> list = new ArrayList<>();
	...
	{
		final List<L2Weapon> list = new ArrayList<>();
	...
	{
		final List<L2EtcItem> list = new ArrayList<>();
