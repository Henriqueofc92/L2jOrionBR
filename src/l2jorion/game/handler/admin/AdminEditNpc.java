...
public class AdminEditNpc implements IAdminCommandHandler
{
	...
	private StringBuilder itemListHtml(final L2TradeList tradeList, final int page)
	{
	...
	private List<L2TradeList> getTradeLists(final int merchantID)
	{
		...
		final List<L2TradeList> tradeLists = new ArrayList<>();
	...
	private void showNpcDropList(final L2PcInstance activeChar, final int npcId, int page)
	{
		...
		StringBuilder htmBuilder = new StringBuilder("<html><title>Npc: " + npcData.getName() + " (" + npcData.getNpcId() + ") drop manage</title>");
	...
	private void showEditDropData(final L2PcInstance activeChar, final int npcId, final int itemId, final int category)
	{
		...
		try
		{
			...
			StringBuilder replyMSG = new StringBuilder("<html><title>Drop editing</title>");
			replyMSG.append("<body>");
	...
	private void showAddDropData(final L2PcInstance activeChar, final L2NpcTemplate npcData)
	{
		...
		StringBuilder replyMSG = new StringBuilder("<html><title>Add drop to: " + npcData.getName() + " (" + npcData.getNpcId() + ")</title>");
		replyMSG.append("<body>");
		replyMSG.append("<table>");
	...
	private void addDropData(final L2PcInstance activeChar, final int npcId, final int itemId, final int min, final int max, final int category, final int chance)
	{
		...
		try
		{
			...
			NpcHtmlMessage adminReply = new NpcHtmlMessage(5);
			StringBuilder replyMSG = new StringBuilder("<html><title>Added successfully</title>");
