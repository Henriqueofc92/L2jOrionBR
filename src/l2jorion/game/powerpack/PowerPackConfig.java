...
public class PowerPackConfig
{
	...
	public static List<String> BUFFER_EXCLUDE_ON = new ArrayList<>();
	...
	public static HashMap<Integer, Integer> FIGHTER_SKILL_LIST;
	public static HashMap<Integer, Integer> MAGE_SKILL_LIST;
	...
	public static ArrayList<Integer> LIST_PRICE_ITEMS = new ArrayList<>();
	...
	public static void load()
	{
		try
		{
			...
			FIGHTER_SKILL_LIST = new HashMap<>();
			MAGE_SKILL_LIST = new HashMap<>();
			...
			GLOBALGK_EXCLUDE_ON = new ArrayList<>();
			...
			GMSHOP_EXCLUDE_ON = new ArrayList<>();
			...
			MARKET_EXCLUDE_ON = new ArrayList<>();
			...
			LIST_PRICE_ITEMS = new ArrayList<>();
