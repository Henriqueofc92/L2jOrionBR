...
public final class L2NpcTemplate extends L2CharTemplate
{
	...
	// Skills AI
	private final ArrayList<L2Skill> _buffSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _negativeSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _debuffSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _atkSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _rootSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _stunSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _sleepSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _paralyzeSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _fossilSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _immobilizeSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _healSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _dotSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _cotSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _universalSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _manaSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _longRangeSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _shortRangeSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _generalSkills = new ArrayList<>();
	private final ArrayList<L2Skill> _suicideSkills = new ArrayList<>();
	...
	private final ArrayList<L2DropCategory> _categories = new ArrayList<>();
	...
	public ArrayList<L2Skill> getUniversalSkills()
	{
		return _universalSkills;
	}
	
	public ArrayList<L2Skill> getSuicideSkills()
	{
		return _suicideSkills;
	}
	
	public ArrayList<L2Skill> getNegativeSkills()
	{
		return _negativeSkills;
	}
	
	public ArrayList<L2Skill> getImmobilizeSkills()
	{
		return _immobilizeSkills;
	}
	
	public ArrayList<L2Skill> getGeneralSkills()
	{
		return _generalSkills;
	}
	
	public ArrayList<L2Skill> getHealSkills()
	{
		return _healSkills;
	}
	
	public ArrayList<L2Skill> getCostOverTimeSkills()
	{
		return _cotSkills;
	}
	
	public ArrayList<L2Skill> getDebuffSkills()
	{
		return _debuffSkills;
	}
	
	public ArrayList<L2Skill> getBuffSkills()
	{
		return _buffSkills;
	}
	
	public ArrayList<L2Skill> getAtkSkills()
	{
		return _atkSkills;
	}
	 ...
	 */
	public ArrayList<L2Skill> getLongRangeSkills()
	{
	 ...
	 */
	public ArrayList<L2Skill> getShortRangeSkills()
	{
