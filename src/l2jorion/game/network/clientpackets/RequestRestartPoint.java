	...
	class DeathTask implements Runnable
	{
		...
		public void run()
		{
			...
			try
			{
				...
				{
					if (DungeonManager.getPlayers().contains(activeChar))
					{
						activeChar.setInstanceId(0);
						DungeonManager.getPlayers().remove(activeChar);
						if (activeChar.getTitle() != null && activeChar.getTitle().equals(DungeonManager.TITLE_PLAYER))
						{
							activeChar.setTitle("");
				...
				switch (_requestedPointType)
				{
					...
					default:
						...
						{
							loc = new Location(17836, 170178, -3507);
							break;
						}
