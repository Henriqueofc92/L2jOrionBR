...
public class L2Attackable extends L2NpcInstance
{
	...
	private HashMap<L2Character, AggroInfo> _aggroList = new HashMap<>();
	
	public final HashMap<L2Character, AggroInfo> getAggroListRP()
	{
		return _aggroList;
	}
	
	public final HashMap<L2Character, AggroInfo> getAggroList()
	{
		return _aggroList;
	}
	...
	private HashMap<L2PcInstance, AbsorberInfo> _absorbersList = new HashMap<>();
	...
	protected void calculateRewards(L2Character lastAttacker)
	{
		...
		try
		{
			...
			List<AggroInfo> aggroSnapshot = new ArrayList<>();
			
			synchronized (getAggroList())
			{
				if (getAggroListRP() != null)
				{
					aggroSnapshot.addAll(getAggroListRP().values());
				}
			}
			
			for (AggroInfo info : aggroSnapshot)
			{
				if (info == null)
				{
					continue;
	...
	public int getHate(L2Character target)
	{
		if (getAggroListRP().isEmpty())
		{
			return 0;
