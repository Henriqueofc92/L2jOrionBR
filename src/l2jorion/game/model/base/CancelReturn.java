...
{
	private static final Logger LOG = LoggerFactory.getLogger(CancelReturn.class);
	
	private L2PcInstance _player = null;
	private HashMap<L2Skill, int[]> _buffs = null;
	
	public CancelReturn(L2PcInstance _player, HashMap<L2Skill, int[]> _buffs)
	{
	...
	public void run()
	{
		...
		for (L2Skill s : new ArrayList<>(_buffs.keySet()))
		{
			if (s == null)
			{
				continue;
