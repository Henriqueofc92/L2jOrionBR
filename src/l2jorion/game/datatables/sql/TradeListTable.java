...
public class TradeListTable
{
	...
	private final HashMap<Integer, L2TradeList> _lists;
	...
	public ArrayList<L2TradeList> getBuyListByNpcId(final int npcId)
	{
		final ArrayList<L2TradeList> lists = new ArrayList<>();
