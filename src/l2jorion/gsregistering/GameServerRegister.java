...
public class GameServerRegister
{
	...
	public static void main(final String[] args) throws IOException
	{
		...
		LOG.info("#--------------------------------------------");
		LOG.info("# Welcome to GameServer Regitering");
		LOG.info("#--------------------------------------------");
		LOG.info("# Type the id of the server you want register");
		LOG.info("# Type 'help' to get a list of ids.");
		LOG.info("# Type 'clean' to unregister all currently");
		LOG.info("# registered gameservers on this LoginServer.");
		LOG.info("#--------------------------------------------");
		while (!_choiceOk)
		{
