...
class Quest (JQuest) :
    ...
    def onAdvEvent (self,event,npc, player) :
        if event == "1" :
            ...
            if machine_instance :
                ...
                print "Dr Chaos AI: problem finding Strange Machine (npcid = "+str(Strange_Machine)+"). Error: not spawned!"
            ...
            if self.isGolemSpawned == 0 :
                ...
                self.isGolemSpawned = 1 # CORRIGIDO: Era ==, agora é =
    ...
    def onKill(self,npc,player,isPet):
        ...
        if npcId == Chaos_Golem :
            ...
            # Opcional: Resetar flag do spawn
            self.isGolemSpawned = 0
        return
